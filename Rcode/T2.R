...
plot(MCMC$dataModels.arrivals.hyper.time.scaleLevel, sub=names(MCMC)[29])
plot(MCMC$dataModels.arrivals.hyper.time.scaleError, sub=names(MCMC)[30])
plot(MCMC$dataModels.departures.likelihood.rate, sub=names(MCMC)[31]) # most problematic chain
plot(MCMC$dataModels.departures.prior.mean, sub=names(MCMC)[32]) # prior ok
plot(MCMC$dataModels.departures.prior.sd, sub=names(MCMC)[33])
...
plot(MCMC$dataModels.departures.hyper.time.scaleError, sub=names(MCMC)[35])
